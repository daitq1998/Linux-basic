...
- **Mô hìnhOSI**
  ...
  | 4 | Transport | Dòng điều khiển buffering, windowing, congestion avoidance. Giúp ngăn ngừa sự mất mát của các phân đoạn trên mạng và sự cần thiết phải truyền lại | Segment | TCP (Transmission Control Protocol ), UDP (User Datagram Protocol) |
